        ...
        <div id="booking-details">
            <div class="booking-data">
                ...
                <div class="booking-date">
					<?php echo sprintf( __( '%s', 'wp-hotel-booking' ), get_the_date( '', $booking_id ) ); ?>
                </div>
            </div>
        </div>
...
<div class="hb-message message">
            <div class="hb-message-content">
				...
				<?php echo __( 'We have received your booking reservation inquiry. We will contact you to complete it soon.', 'wp-hotel-booking' ); ?>
            </div>
        </div>

        <div id="booking-items">

            <h3><?php echo __( 'Your Summary', 'wp-hotel-booking' ); ?></h3>
        ...
        <div id="booking-customer">
             ...
             <h3><?php echo __( 'Personal Info', 'wp-hotel-booking' ); ?></h3>
            ...
            <div class="booking-notes">
				...
				<p><?php echo esc_html( $booking->post->post_content ); ?></p>
            </div>
