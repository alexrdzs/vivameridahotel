...
<div class="hb-order-new-customer" id="hb-order-new-customer">
    ...
    <div class="hb-col-padding hb-col-border">
        ...
        <h5><?php _e( 'Personal Information', 'tp-hotel-booking' ); ?></h5>
        <p>This information will be used to contact you and complete your reservation.</p>
        <ul class="hb-form-table col-2">
            ...
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="first_name" value="<?php echo esc_attr( $customer->first_name ); ?>" placeholder="<?php _e( 'First Name', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
            <li class="hb-form-field">
            ...
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="phone" value="<?php echo esc_attr( $customer->phone ); ?>" placeholder="<?php _e( 'Phone', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
            <li class="hb-form-field">
                <label class="hb-form-field-label"><?php _e( 'Email', 'tp-hotel-booking' ); ?>
                 ...
                 <div class="hb-form-field-input">
                    <input type="email" name="email" value="<?php echo esc_attr( $customer->email ); ?>" placeholder="<?php _e( 'Email', 'tp-hotel-booking' ); ?>" required />
                </div> 
            </li>
            <!-- <li class="hb-form-field">
        ...
        <ul class="hb-form-table col-2">
            ...
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="address" value="<?php echo esc_attr( $customer->address ); ?>" placeholder="<?php _e( 'Address Line', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="city" value="<?php echo esc_attr( $customer->city ); ?>" placeholder="<?php _e( 'City', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="state" value="<?php echo esc_attr( $customer->state ); ?>" placeholder="<?php _e( 'State or Province', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
            ...
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input">
                    <input type="text" name="postal_code" value="<?php echo esc_attr( $customer->postal_code ); ?>" placeholder="<?php _e( 'Postal code', 'tp-hotel-booking' ); ?>" required />
                </div>
            </li>
