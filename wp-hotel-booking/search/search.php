...
<div id="hotel-booking-search-<?php echo uniqid(); ?>" class="hotel-booking-search">
    ...
    <form name="hb-search-form" action="<?php echo esc_attr($search_page); ?>"
        ...
        <ul class="hb-form-table">
            ...
            <?php if (isset($thim_options_data['thim_adults_show']) && $thim_options_data['thim_adults_show'] == '1') { ?>
                <li class="hb-form-field">
            ...
            <?php } ?>
            <?php if (isset($thim_options_data['thim_children_show']) && $thim_options_data['thim_children_show'] == '1') { ?>
                <li class="hb-form-field">
